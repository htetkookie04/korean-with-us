...
export default function GalleryPage() {
  ...
  return (
    <>
      <Helmet>
        <title>Gallery & Memories - Korean With Us</title>
        <meta name="description" content="Discover the vibrant learning community at Korean With Us through photos and videos of our classes, cultural events, and student achievements." />
      </Helmet>
          ...
          <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
              <div className="p-6">
                ...
                <div className={`${selectedImage.background} rounded-lg h-64 flex items-center justify-center mb-4 relative`}>
