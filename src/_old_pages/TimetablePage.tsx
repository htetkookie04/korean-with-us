...
export default function TimetablePage() {
  ...
  return (
    <>
      <Helmet>
        <title>Class Timetable - Korean With Us</title>
        <meta name="description" content="Find the perfect class schedule that fits your lifestyle. We offer flexible timing options from morning to evening, including weekend intensive courses." />
      </Helmet>
